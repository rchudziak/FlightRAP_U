@AbapCatalog.sqlViewName: 'ZISUPPL'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Supplement View - CDS Data Model'
define view ZI_Supplement
  as select from /dmo/supplement as Supplement
  association [0..*] to ZI_SupplementText as _SupplText on $projection.SupplementID = _SupplText.SupplementID
